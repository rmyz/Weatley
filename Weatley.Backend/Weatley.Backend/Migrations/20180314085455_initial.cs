        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 3, 14, 9, 54, 55, 22, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartingDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 3, 14, 9, 54, 55, 27, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalPrice = table.Column<double>(nullable: false),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 3, 14, 9, 54, 55, 32, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    StartHour = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 3, 14, 9, 54, 55, 25, DateTimeKind.Local))
                },
                constraints: table =>
                {
